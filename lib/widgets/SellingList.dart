...
import '../services/sellingPost_service.dart';
          ...
          return AlertDialog(
            ...
            actions: [
              TextButton(
                  onPressed: () {
                    setState(() {
                      fsSellingService.removeSellingPost(id);
                    });
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Text(
                                          snapshotPost.data![i].datePosted.toString(),
                                          textAlign: TextAlign.left,
                                          style: TextStyle(fontSize: 10),
                                        )
                                      ],
                              ...
                              subtitle: Column(
                                children: [
                                    ...
                                    child: Column(
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(snapshotPost.data![i].location),
                                        ),
                                        Image(
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      "Product:" +snapshotPost.data![i].item,
                                      textAlign: TextAlign.left,
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(left: 15, top: 25),
                                    child: Text(
                                      "Contact:" +snapshotPost.data![i].phoneNumber.toString(),
                                      textAlign: TextAlign.left,
                                      style: TextStyle(color: Colors.black, fontSize: 15),
                                    ),
                                  ),
